...
At the **end of each conversation**, review what was discovered and check whether any facts in this skill are new, corrected, or outdated (e.g. new heap sizing data, new Kconfig options, new monitoring patterns, updated stack margin guidelines).
