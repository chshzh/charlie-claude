...
At the **end of each conversation**, review what was discovered and check whether any facts in this skill are new, corrected, or outdated (e.g. new critical Kconfig requirements, new sub-skill routing patterns, updated NCS Wi-Fi constraints).
